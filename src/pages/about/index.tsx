...
const AboutPage: React.FC<PageProps> = () => {
  return (
    <AboutLayout>
      <ContentWrapper>
        <p>
          <strong>개발</strong>자로 오랫동안 살아왔지만 언제나 다른 삶을 꿈꾸며
          살아가고 있습니다. 다양한 삶을 경험해보고 싶은데 인생은 참 짧네요.
          기술이 인문 안에 자리잡아야 인간이 더 나은 삶을 살아갈 수 있다고 믿는
          만큼 제가 가진 기술이 그런 가치를 가질 수 있도록 노력하고 있습니다.
        </p>
        <p>
          ...
          있다고 느끼게 되면 음악을 멀리하게 될 때가 있어요. 그래서 슬퍼요.
        </p>
        <p>
